...
export const MAPS = {
  ...
  peixian: {
    ...
    portals: [
      { x: 5 * 16, y: 15 * 16 - 4, w: 16, h: 8, targetMap: 'liu_home',
        targetX: 5 * 16, targetY: 12 * 16, label: '刘邦家' },
      { x: 26 * 16, y: 17 * 16 - 4, w: 16, h: 8, targetMap: 'xianya',
        targetX: 5 * 16, targetY: 10 * 16, label: '县衙' },
      { x: 11 * 16, y: 6 * 16 - 4, w: 16, h: 8, targetMap: 'jiusi',
        targetX: 5 * 16, targetY: 12 * 16, label: '酒肆' },
      { x: 30 * 16, y: 11 * 16, w: 8, h: 16, targetMap: 'mangdang',
        targetX: 2 * 16, targetY: 11 * 16, label: '→芒砀山' },
    ],
  ...
  liu_home: {
    ...
    portals: [
      { x: 4 * 16, y: 12 * 16 + 4, w: 48, h: 4, targetMap: 'peixian',
        targetX: 5 * 16, targetY: 15 * 16 + 8, label: '出门' },
    ],
  ...
  xianya: {
    ...
    portals: [
      { x: 4 * 16, y: 12 * 16 + 4, w: 48, h: 4, targetMap: 'peixian',
        targetX: 26 * 16, targetY: 17 * 16 + 8, label: '出门' },
    ],
    playerSpawn: { x: 5 * 16, y: 10 * 16 },
  },
  ...
  jiusi: {
    ...
    portals: [
      { x: 4 * 16, y: 10 * 16 + 4, w: 48, h: 4, targetMap: 'peixian',
        targetX: 11 * 16, targetY: 6 * 16 + 8, label: '出门' },
    ],
  ...
  mangdang: {
    ...
    portals: [
      { x: 2 * 16, y: 11 * 16, w: 8, h: 16, targetMap: 'peixian',
        targetX: 29 * 16, targetY: 11 * 16, label: '←回沛县' },
      { x: 22 * 16, y: 1 * 16, w: 48, h: 4, targetMap: 'mangdang_deep',
        targetX: 14 * 16, targetY: 18 * 16, label: '深山↓' },
    ],
  ...
  mangdang_deep: {
    ...
    portals: [
      { x: 14 * 16, y: 18 * 16 + 4, w: 48, h: 4, targetMap: 'mangdang',
        targetX: 22 * 16, targetY: 3 * 16, label: '出洞' },
      { x: 26 * 16, y: 14 * 16, w: 16, h: 24, targetMap: 'peixian',
        targetX: 16 * 16, targetY: 11 * 16, label: '回沛县(交任务)' },
      { x: 26 * 16, y: 1 * 16, w: 48, h: 4, targetMap: 'xianyang',
        targetX: 5 * 16, targetY: 10 * 16, label: '→咸阳' },
    ],
  ...
  xianyang: {
    ...
    portals: [
      { x: 3 * 16, y: 1 * 16, w: 48, h: 4, targetMap: 'mangdang_deep',
        targetX: 26 * 16, targetY: 3 * 16, label: '←芒砀山' },
      { x: 14 * 16, y: 1 * 16 - 2, w: 32, h: 4, targetMap: 'xianyang_palace',
        targetX: 12 * 16, targetY: 14 * 16, label: '秦王宫↓' },
      { x: 26 * 16, y: 11 * 16, w: 8, h: 16, targetMap: 'hongmen',
        targetX: 2 * 16, targetY: 11 * 16, label: '→鸿门' },
    ],
  ...
  xianyang_palace: {
    ...
    portals: [
      { x: 12 * 16, y: 14 * 16 + 2, w: 32, h: 4, targetMap: 'xianyang',
        targetX: 14 * 16, targetY: 3 * 16, label: '出宫' },
    ],
  ...
  hongmen: {
    ...
    portals: [
      { x: 2 * 16, y: 11 * 16, w: 8, h: 16, targetMap: 'xianyang',
        targetX: 25 * 16, targetY: 11 * 16, label: '←咸阳' },
      { x: 14 * 16, y: 8 * 16, w: 32, h: 4, targetMap: 'hongmen_tent',
        targetX: 12 * 16, targetY: 14 * 16, label: '大帐↓' },
    ],
    playerSpawn: { x: 4 * 16, y: 11 * 16 },
  },
  ...
  hongmen_tent: {
    ...
    portals: [
      { x: 12 * 16, y: 14 * 16 + 2, w: 32, h: 4, targetMap: 'hongmen',
        targetX: 14 * 16, targetY: 9 * 16, label: '出帐' },
      { x: 23 * 16, y: 7 * 16, w: 16, h: 24, targetMap: 'hanzhong',
        targetX: 4 * 16, targetY: 11 * 16, label: '→汉中' },
    ],
    playerSpawn: { x: 12 * 16, y: 12 * 16 },
  },
  ...
  hanzhong: {
    ...
    portals: [
      { x: 4 * 16, y: 11 * 16, w: 8, h: 16, targetMap: 'hongmen_tent',
        targetX: 23 * 16, targetY: 10 * 16, label: '←鸿门' },
      { x: 24 * 16, y: 11 * 16, w: 8, h: 16, targetMap: 'chencang',
        targetX: 4 * 16, targetY: 11 * 16, label: '→陈仓' },
    ],
  ...
  chencang: {
    ...
    portals: [
      { x: 4 * 16, y: 11 * 16, w: 8, h: 16, targetMap: 'hanzhong',
        targetX: 23 * 16, targetY: 11 * 16, label: '←汉中' },
      { x: 24 * 16, y: 11 * 16, w: 8, h: 16, targetMap: 'pengcheng',
        targetX: 4 * 16, targetY: 11 * 16, label: '→彭城' },
    ],
  ...
  pengcheng: {
    ...
    portals: [
      { x: 2*16, y: 11*16, w: 8, h: 16, targetMap: 'chencang', targetX: 23*16, targetY: 11*16, label: '←陈仓' },
      { x: 25*16, y: 14*16, w: 8, h: 16, targetMap: 'xingyang', targetX: 4*16, targetY: 11*16, label: '→荥阳' },
    ],
    playerSpawn: { x: 4*16, y: 11*16 },
  },
  ...
  xingyang: {
    ...
    portals: [
      { x: 4*16, y: 11*16, w: 8, h: 16, targetMap: 'pengcheng', targetX: 24*16, targetY: 14*16, label: '←彭城' },
      { x: 24*16, y: 14*16, w: 8, h: 24, targetMap: 'gaixia', targetX: 4*16, targetY: 11*16, label: '→垓下' },
    ],
    playerSpawn: { x: 6*16, y: 11*16 },
  },
  ...
  gaixia: {
    ...
    portals: [
      { x:4*16, y:11*16, w:8, h:16, targetMap:'xingyang', targetX:23*16, targetY:15*16, label:'←荥阳' },
      { x:26*16, y:11*16, w:8, h:24, targetMap:'wujiang', targetX:4*16, targetY:11*16, label:'→乌江' },
    ],
    playerSpawn: { x:6*16, y:11*16 },
  },
  ...
  wujiang: {
    ...
    portals: [
      { x:4*16, y:11*16, w:8, h:16, targetMap:'gaixia', targetX:25*16, targetY:11*16, label:'←垓下' },
      { x:22*16, y:5*16, w:8, h:16, targetMap:'changan', targetX:4*16, targetY:11*16, label:'→定陶' },
    ],
    playerSpawn: { x:6*16, y:11*16 },
  },
  ...
  changan: {
    ...
    portals: [
      { x:4*16, y:11*16, w:8, h:16, targetMap:'wujiang', targetX:21*16, targetY:6*16, label:'←乌江' },
      { x:24*16, y:5*16, w:8, h:20, targetMap:'changle_palace', targetX:12*16, targetY:14*16, label:'→长乐宫' },
    ],
    playerSpawn: { x:6*16, y:11*16 },
  },
  ...
  changle_palace: {
    ...
    portals: [
      { x:12*16, y:14*16+2, w:32, h:4, targetMap:'changan', targetX:24*16, targetY:7*16, label:'出宫' },
      { x:24*16, y:7*16, w:8, h:16, targetMap:'peixian_return', targetX:2*16, targetY:11*16, label:'→沛县' },
    ],
    playerSpawn: { x:12*16, y:12*16 },
  },
  ...
  peixian_return: {
    ...
    portals: [
      { x:2*16, y:11*16, w:8, h:16, targetMap:'changle_palace', targetX:23*16, targetY:8*16, label:'←长安' },
    ],
    playerSpawn: { x:4*16, y:11*16 },
  },
};
